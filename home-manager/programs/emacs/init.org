...
#+begin_src emacs-lisp
  (use-package corfu
    :bind (:map corfu-map ("TAB" . corfu-next)   ("S-TAB". corfu-previous))
...
#+begin_src emacs-lisp
  (use-package org-fragtog
    ...
    :hook ((org-mode . org-fragtog-mode)
           (mu4e-compose-mode . org-fragtog-mode)))
#+end_src
  ...
  (defun nuance/nv-find-note ()
    ...
    (let* ((default-directory (nuance/nv--notes-path))
           (selection (selectrum--read
                       ...
                       :initial-input (when (region-active-p) (buffer-substring (region-beginning) (region-end)))))
           (parts (split-string selection ":")))
      (if (length> parts 1)
