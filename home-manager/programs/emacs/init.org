...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "s-0") (lambda () (interactive) (org-agenda nil "d")))
#+END_SRC
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "s-I") (lambda () (interactive) (let ((default-directory "~/org")) (nuance/project-git-grep))))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package org-mu4e
    ...
    :hook (org-ctrl-c-ctrl-c . (lambda () (htmlize-and-send)))
    :bind (("C-x m" . mu4e-compose-org-mail)))
#+end_src
