...
#+begin_src emacs-lisp
  (use-package orderless
    ...
    (setq completion-styles '(orderless)
          ...
          completion-category-overrides '((file (styles . (partial-completion))) (nuance/dynamic (styles . (basic))))))
#+end_src
