  ...
  (use-package project
    ...
    See `consult-grep' for more details regarding the asynchronous search."
      ...
      (let* ((default-directory (project-root project))
             (path (nuance/find-by-name (format "%s: " (nuance/project-name project)) (lambda (input) (nuance/find-by-name-builder project input)) (nuance/project-find-by-name-initial project))))
...
#+BEGIN_SRC emacs-lisp
  (use-package eldoc :hook ((prog-mode org-mode) . eldoc-mode) :custom ((eldoc-idle-delay 2.5)))
